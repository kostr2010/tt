...
int main() {
    ...
    Node* dst = TreeCopySubtree(tree, tree->root);

    TreeGlueSubtree(tree, dst, TreeCountSubtree(tree, tree->root), tree->root, left);
    TreeGlueSubtree(tree, dst, TreeCountSubtree(tree, tree->root), 8, left);
    TreeGlueSubtree(tree, dst, TreeCountSubtree(tree, tree->root), 8, right);
